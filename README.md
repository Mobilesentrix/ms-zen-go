...
```bash
go get github.com/Mobilesentrix/ms-zen-go
```
...
* **Go** - [GitHub](https://github.com/Mobilesentrix/ms-zen-go) | [Documentation](https://gorules.io/docs/developers/bre/engines/go)
